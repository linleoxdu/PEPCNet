...
from CystSeg.utils.scheduler import LinoPolyScheduler
from CystSeg.optimizers.lr_scheduler import LinearWarmupCosineAnnealingLR
from CystSeg.trainer.trainer_ours import run_training
from CystSeg.utils.ours_data_utils import get_loader

parser = argparse.ArgumentParser(description="EDGE HEATMAP REGRESSION")
parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="exp_cyst", type=str,
...
def main_worker(gpu, args):
    ...
    if args.lrschedule == "warmup_cosine":
        ...
        scheduler = LinoPolyScheduler(optimizer, power=0.9, total_steps=args.max_epochs)
    else:
        scheduler = None
